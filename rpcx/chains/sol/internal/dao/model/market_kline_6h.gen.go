...
const TableNameMarketKline6h = "market_kline_6h"

// MarketKline6h mapped from table <market_kline_6h>
...
// TableName MarketKline6h's table name
func (*MarketKline6h) TableName() string {
	return TableNameMarketKline6h
}
