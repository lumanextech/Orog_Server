...
const TableNameMarketKline1h = "market_kline_1h"

// MarketKline1h mapped from table <market_kline_1h>
...
// TableName MarketKline1h's table name
func (*MarketKline1h) TableName() string {
	return TableNameMarketKline1h
}
