...
const TableNameMarketKline1m = "market_kline_1m"

// MarketKline1m mapped from table <market_kline_1m>
...
// TableName MarketKline1m's table name
func (*MarketKline1m) TableName() string {
	return TableNameMarketKline1m
}
