...
// SetWithMatedata sets the "withMatedata" parameter.
func (inst *OpenPositionV2) SetWithMatedata(withMatedata bool) *OpenPositionV2 {
	inst.WithMatedata = &withMatedata
	return inst
}
...
func (inst *OpenPositionV2) Validate() error {
	// Check whether all (required) parameters are set:
	{
		...
		if inst.WithMatedata == nil {
			return errors.New("WithMatedata parameter is not set")
		}
	}
			...
			programBranch.Child(ag_format.Instruction("OpenPositionV2")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Params[len=9]").ParentFunc(func(paramsBranch ag_treeout.Branches) {
						...
						paramsBranch.Child(ag_format.Param("            WithMatedata", *inst.WithMatedata))
...
func (obj OpenPositionV2) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	...
	// Serialize `WithMatedata` param:
	err = encoder.Encode(obj.WithMatedata)
	if err != nil {
		return err
	}
...
func (obj *OpenPositionV2) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	...
	// Deserialize `WithMatedata`:
	err = decoder.Decode(&obj.WithMatedata)
	if err != nil {
		return err
	}
