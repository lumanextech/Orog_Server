...
func (inst *SerumSwap) SetOrderPayerTokenAccountAccount(orderPayerTokenAccount ag_solanago.PublicKey) *SerumSwap {
...
func (inst *SerumSwap) GetOrderPayerTokenAccountAccount() *ag_solanago.AccountMeta {
...
func NewSerumSwapInstruction(
	...
	return NewSerumSwapInstructionBuilder().
		...
		SetOrderPayerTokenAccountAccount(orderPayerTokenAccount).
