...
type GetXTopMarketListLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewGetXTopMarketListLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetXTopMarketListLogic {
	return &GetXTopMarketListLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *GetXTopMarketListLogic) GetXTopMarketList(in *sol.GetMarketListRequest) (*sol.RealTimeMarketListResponse, error) {
	page := in.Page
	size := in.Size
	orderBy := in.OrderBy
